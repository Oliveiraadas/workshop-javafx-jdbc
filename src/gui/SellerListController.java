...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		// CORREÇÃO AQUI: Mudado de tableColumnBaseSalary para tableColumnSalary
...
//		} catch (IOException e) {
//			Alerts.showAlert("IO Exception", "Error loadin", e.getMessage(), AlertType.ERROR);
//		}
	}
	...
	private void removeEntity(Seller obj) {
		Optional<ButtonType> result = Alerts.showConfirmation("Confirmaton", "Are you sure to delete");
